...
def upgrade():
    ...
    op.create_table('eva_permission',
    ...
    op.create_table('eva_identity__role',
    ...
    op.create_table('eva_role__permission',
    sa.Column('role_id', sa.Integer(), nullable=True),
    ...
    # 查找 admin
    credential = db.query(Credential).filter(sa.and_(
