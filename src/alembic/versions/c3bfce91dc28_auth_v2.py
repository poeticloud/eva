...
def upgrade():
    ...
    op.create_table('eva_idp',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=32), nullable=False),
    sa.Column('type', sa.Enum('LDAP', 'OIDC', 'GOOGLE', 'FACEBOOK', 'TWITTER', 'GITHUB', 'GITLAB', 'WECHAT', 'WEIBO', name='idptype'), nullable=False),
    ...
    op.create_table('eva_credential',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('identifier', sa.String(length=64), nullable=False),
    sa.Column('identifier_type', sa.Enum('USERNAME', 'EMAIL', 'PHONE', 'IDP', name='identifiertype'), nullable=False),
    ...
    op.create_table('eva_securitycode',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('shadow', sa.String(length=512), nullable=False),
    sa.Column('credential_id', sa.Integer(), nullable=True),
    sa.Column('created', sa.DateTime(), nullable=True),
...
def downgrade():
    ...
    op.create_table('auth_app',
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('auth_app_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('app_id', postgresql.UUID(), autoincrement=False, nullable=True),
    sa.Column('app_secret', sa.VARCHAR(length=256), autoincrement=False, nullable=False),
    ...
    sa.Column('created', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('updated', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['auth_user.id'], name='auth_app_user_id_fkey'),
    ...
    op.create_table('auth_app_session',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('refresh_token', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['app_id'], ['auth_app.id'], name='auth_app_session_app_id_fkey'),
    ...
    op.create_table('auth_user_session',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('refresh_token', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('created', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('expires_in', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['auth_user.id'], name='auth_user_session_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='auth_user_session_pkey'),
    sa.UniqueConstraint('refresh_token', name='auth_user_session_refresh_token_key')
    )
